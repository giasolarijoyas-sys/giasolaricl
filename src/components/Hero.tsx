      ...
      >
        <div className="w-full" style={{ padding: "24px" }}>
          <div className="md:p-[80px] md:pl-[64px] p-0 max-w-[560px]">
            ...
            >
              <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
              ...
              Síguenos en Instagram y TikTok: @giasolarijoyas
            </a>
          </div>
        </div>
      </div>
