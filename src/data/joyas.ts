...
export const JOYAS: Joya[] = [
  ...
  {
    slug: "vintage-020",
    nombre: "Cintillo Matilde",
    categoria: "Cintillo",
    material: "Oro 18k amarillo, Diamante",
    metalPrincipal: "Oro 18k amarillo",
    estilo: "Vintage",
    piedraCentral: "Diamante",
    descripcion: "Cintillo en oro 18k amarillo con diamantes alternados.",
    descripcionLarga:
      "Pieza única hecha a mano. La piedra, el metal y los detalles se conversan a medida según disponibilidad. Cada anillo incluye Certificado Gia Solari.",
  ...
  {
    slug: "vintage-052",
    nombre: "Cintillo Zita",
    categoria: "Cintillo",
    material: "Oro 18k amarillo",
    metalPrincipal: "Oro 18k amarillo",
    estilo: "Vintage",
    piedraCentral: "Ninguna",
    descripcion: "Cintillo fino en oro 18k amarillo.",
    descripcionLarga:
      "Pieza única hecha a mano. La piedra, el metal y los detalles se conversan a medida según disponibilidad. Cada anillo incluye Certificado Gia Solari.",
  ...
  {
    slug: "vintage-058",
    nombre: "Cintillo Concha",
    categoria: "Cintillo",
    material: "Oro 18k amarillo, Diamante",
    metalPrincipal: "Oro 18k amarillo",
    estilo: "Vintage",
    piedraCentral: "Diamante",
    descripcion: "Cintillo grabado con diamantes en oro 18k amarillo.",
    descripcionLarga:
      "Pieza única hecha a mano. La piedra, el metal y los detalles se conversan a medida según disponibilidad. Cada anillo incluye Certificado Gia Solari.",
