...
export const PIEDRAS: Piedra[] = [
  ...
  },
  {
    slug: "amatista",
    nombre: "Amatista",
    subtitulo: "La Piedra de la Sabiduría",
    color: "#6E4E8A",
    datos: [
      { label: "Etimología", value: 'Del griego "amethystos" (no ebria)' },
      { label: "Familia", value: "Cuarzo violeta" },
      { label: "Chakra", value: "Tercer Ojo y Corona" },
      { label: "Simbolismo", value: "Sabiduría, claridad mental, espiritualidad" },
    ],
    historia:
      "La leyenda cuenta que Dionisio derramó vino sobre una estatua de cuarzo y la tiñó de violeta. Desde entonces, los griegos creyeron que la amatista daba claridad mental incluso en los momentos más confusos. En la Edad Media, los obispos católicos la llevaban como símbolo de pureza espiritual — y aún la usan hoy.",
    frases: [
      "Los griegos la llamaban no ebria. Daba claridad incluso en los momentos más confusos.",
      "La piedra de los obispos hace siglos. Sabiduría y pureza espiritual.",
    ],
    propiedades: [
    ...
    paraQuienta: "Para las espirituales, las que meditan, las que buscan calma.",
  },
  {
    slug: "morganita",
    nombre: "Morganita",
    subtitulo: "La Piedra del Amor Divino",
    color: "#E2B6B0",
    datos: [
      { label: "Origen del nombre", value: "Bautizada por Tiffany en honor a J.P. Morgan" },
      { label: "Familia", value: "Berilo" },
      { label: "Chakra", value: "Corazón" },
      { label: "Simbolismo", value: "Amor incondicional, ternura, sanación" },
    ],
    historia:
      "Descubierta en Madagascar en 1910 y bautizada por Tiffany & Co. Es la nueva favorita de las novias modernas en todo el mundo. Su tono rosa pálido se asocia con el amor divino: un amor más allá de la pasión, hecho de ternura y compasión. La piedra del amor maduro.",
    frases: [
      "La piedra del amor divino. No del que arde, sino del que cuida, que sostiene, que abraza.",
      "Si tu amor es del que se elige todos los días sin necesidad de probar nada, esta es tu piedra.",
    ],
    propiedades: [
      "Sanación emocional del corazón",
      "Amor incondicional",
      "Conexión con la feminidad",
      "Calma en las relaciones",
    ],
    paraQuienta:
      "Para las románticas, las femeninas. Tendencia mundial en compromiso. Combina con oro rosado.",
  },
  {
    slug: "perla",
    nombre: "Perla",
    subtitulo: "La Piedra del Tiempo y la Paciencia",
    color: "#EDE6DA",
    datos: [
      { label: "Origen", value: "La única gema viva del mundo" },
      { label: "Dureza", value: "2.5 – 4.5 / 10" },
      { label: "Simbolismo", value: "Pureza, paciencia, sabiduría emocional" },
    ],
    historia:
      "La perla es la única gema del mundo que no se extrae: nace de un ser vivo. Tarda entre 2 y 7 años en formarse capa por capa dentro de una ostra. La obsesión de Cleopatra, Isabel I, Lady Di, Coco Chanel. Coco decía: 'una mujer sin perlas no está vestida'.",
    frases: [
      "La única gema que nace de un ser vivo. Lo que entró como irritación, con tiempo, se convirtió en lo más bello.",
      "La única joya que no se extrae: se construye. Como las relaciones que duran.",
    ],
    propiedades: [
      "Pureza y sabiduría emocional",
      "Calma profunda",
      "Conexión con lo femenino y lunar",
      "Paciencia y tiempo",
    ],
    paraQuienta:
      "Para las clásicas, las elegantes. Joyería de boda. Regalos a guaguas. Bodas de perla (30 años).",
  },
];
